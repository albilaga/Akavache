...
```
### Linker for Xamarin
For Xamarin.iOS you need to add these code somewhere in your code to make sure it is not linked by linker. It is also good for Xamarin.Android to also put it if you using Link All
